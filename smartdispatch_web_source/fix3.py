...
while i < len(lines):
    if i == 1433: # dashboard
        ...
        new_lines.append("            <HistoryPage\n")
        new_lines.append("              orders={orders}\n")
        new_lines.append("              selectedHistoryCustomer={selectedHistoryCustomer}\n")
        new_lines.append("              setSelectedHistoryCustomer={setSelectedHistoryCustomer}\n")
        new_lines.append("              addToast={addToast}\n")
        new_lines.append("            />\n")
        new_lines.append("          )}\n")
        i = 3073
